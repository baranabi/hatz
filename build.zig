//! Build script for the hatz executable and tooling.
...
/// Configure build targets and top-level steps for the app and tools.
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "hatz" is the name you will use in your source code to
                // import this module (e.g. `@import("hatz")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "hatz", .module = mod },
    ...
    const replay_exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("tools/contract/replay/main.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "engine", .module = engine },
    ...
    const replay_step = b.step("replay", "Replay contract fixtures");
    const replay_cmd = b.addRunArtifact(replay_exe);
    replay_step.dependOn(&replay_cmd.step);

    const replay_check_step = b.step("replay-check", "Replay contract fixtures and compare against expected outputs");
    const replay_check_cmd = b.addRunArtifact(replay_exe);
    replay_check_cmd.addArgs(&.{ "--check" });
    replay_check_step.dependOn(&replay_check_cmd.step);
